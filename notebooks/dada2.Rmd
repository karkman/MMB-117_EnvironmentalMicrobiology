...
And we need to set the working directory to the right folder (change the command below to point to your own folder).  

```{r}
setwd("/scratch/project_2007145/USERNAME/MMB-117/MMB-117_EnvironmentalMicrobiology/")
```
...
```{r}
path <- "/scratch/project_2007145/USERNAME/MMB-117/MMB-117_EnvironmentalMicrobiology/trimmed_data/bac_data"
```
