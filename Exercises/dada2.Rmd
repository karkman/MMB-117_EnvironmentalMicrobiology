...
Then we can assign taxonomy to the ASVs. And print the first few rows of the taxonomy table.  
...
And save the taxonomy table as an RDS file.

```{r "saveTaxa", eval=FALSE}
