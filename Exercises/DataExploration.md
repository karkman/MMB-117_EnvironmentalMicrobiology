...
MMB117metadata <- sample_data(physeq) %>% rownames_to_column("Sample")
...
of ASVs that are detected only less than 3 times.
...
Ordination with all samples and without the negative control.
