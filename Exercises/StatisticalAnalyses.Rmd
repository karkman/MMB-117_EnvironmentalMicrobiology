...
We will use the `phyloseq` and `microViz` packages to visualise the data and `vegan` package to test the hypothesis.  
...
We can use phyloseq to normalise and rarefy the data. And use a fucntion from vegan to do the CLR transformation.
