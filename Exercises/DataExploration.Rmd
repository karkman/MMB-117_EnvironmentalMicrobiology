...
We can also remove the BI negative control. And we should remove it from the metadata as well.  
...
This is not exactly true: The normality should be met at each X value.  This is of difficult to check if the data does not have multiple observations for each X and we don't. 
